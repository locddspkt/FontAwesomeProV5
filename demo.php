...
$instance = FontAwesomeProV5\FontAwesomeProV5_Service::GetInstance(
    array(
        'defaultFolder' => __DIR__ . '/test/fa-pro-icons'
    )
);

$instance->LoadPreCss();

$appleProIcon = $instance->Load('far_fa-apple-alt.svg');
$copyProIcon = $instance->Load('fal_fa-copy.svg', 'copy-in-red-color fa-4x');
